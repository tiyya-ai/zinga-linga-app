...
export const ReportsPageEnhanced: React.FC<ReportsPageEnhancedProps> = ({ 
  users, 
  modules, 
  purchases, 
  onRefresh 
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {reportTypes.map((report) => (
          <div
            ...
            className={`cursor-pointer rounded-2xl p-6 shadow-lg border-2 transition-all duration-300 hover:shadow-xl ${
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <div className={`p-3 rounded-full bg-gradient-to-br ${report.color}`}>
                <report.icon className="w-6 h-6 text-white" />
              </div>
              <div className="flex-1">
                <h4 className="text-lg font-mali font-bold text-gray-800">{report.title}</h4>
                <p className="font-mali text-gray-600 text-sm">{report.description}</p>
              </div>
            </div>
            
            {selectedReport === report.id && (
              <div className="mt-4 p-3 bg-blue-100 rounded-lg">
                <p className="font-mali text-blue-800 text-sm font-bold">✓ Selected Report Type</p>
              </div>
            )}
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center">
          ...
          <h4 className="text-2xl font-mali font-bold text-gray-800">6</h4>
          <p className="font-mali text-gray-600">Report Types</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center">
          ...
          <h4 className="text-2xl font-mali font-bold text-gray-800">24</h4>
          <p className="font-mali text-gray-600">Downloads Today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center">
          ...
          <h4 className="text-2xl font-mali font-bold text-gray-800">2m</h4>
          <p className="font-mali text-gray-600">Avg Generation Time</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center">
          ...
          <h4 className="text-2xl font-mali font-bold text-gray-800">Live</h4>
          <p className="font-mali text-gray-600">Real-time Data</p>
        </div>
      </div>
    </div>
  );
