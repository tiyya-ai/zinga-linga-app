...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  ...
  return (
    <>
      ...
      {/* Demo Section */}
      <section id="demo" className="py-20 px-4 bg-gradient-to-br from-brand-blue via-brand-pink to-brand-red relative">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-10 left-20 w-24 h-24 bg-white/10 rounded-full animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-32 h-32 bg-brand-yellow/20 rounded-full animate-bounce"></div>
          <PlayCircle className="absolute top-32 right-20 w-20 h-20 text-white/20 animate-spin" style={{ animationDuration: '8s' }} />
        </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl font-mali text-pink-100 mb-8">
              Experience the magic with our free demo
            </p>
          </div>
              ...
              <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    <PlayCircle className="w-20 h-20 text-white mb-4 mx-auto hover:scale-110 transition-transform cursor-pointer" />
                    <p className="text-white font-mali font-bold text-lg">Watch Demo</p>
                    <p className="text-white/80 font-mali text-sm">2 minutes of jungle fun!</p>
                  </div>
                  
                  {/* Animated elements in video preview */}
                ...
                <div className="mt-6 text-center">
                  <h3 className="text-2xl font-mali font-bold text-white mb-2">Free Sample Adventure</h3>
                  <p className="font-mali text-pink-100 mb-4">
                    Join Kiki as she discovers the letter "A" with an amazing African Antelope!
                  </p>
                  <button 
                    onClick={onLoginClick}
                    className="bg-gradient-to-r from-brand-yellow to-brand-red text-white font-mali font-bold py-3 px-8 rounded-full hover:from-brand-yellow hover:to-brand-red transform hover:scale-105 transition-all duration-300 shadow-lg"
                  >
            ...
            <div className="space-y-6">
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-mali font-bold text-white">Interactive Learning</h4>
                </div>
                <p className="font-mali text-pink-100">Touch, tap, and explore with Kiki and Tano as your guides!</p>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-mali font-bold text-white">Engaging Videos</h4>
                </div>
                <p className="font-mali text-pink-100">Beautiful animations bring African animals and letters to life!</p>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h4 className="text-xl font-mali font-bold text-white">Cultural Discovery</h4>
                </div>
                <p className="font-mali text-pink-100">Learn about amazing African animals while mastering the alphabet!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="modules" className="py-20 px-4 bg-gradient-to-br from-brand-blue via-brand-pink to-brand-red relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-2xl transform hover:scale-105 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="font-mali text-purple-100 text-lg mb-4">Perfect for ages 1-3 years</p>
              ...
              <div className="text-center">
                ...
                <p className="font-mali text-purple-200 text-sm mt-3">One-time purchase • Lifetime access</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-2xl transform hover:scale-105 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="font-mali text-purple-100 text-lg mb-4">Perfect for ages 2-6 years</p>
