...
import { bundleOffers } from '../data/modules';
...
export const UserDashboard: React.FC<UserDashboardProps> = ({ user, onLogout, onPurchase }) => {
  ...
  // Load modules from dataStore (same as admin)
  useEffect(() => {
    const loadModules = () => {
      try {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-mali text-gray-600">Loading your dashboard...</p>
        </div>
      </div>
    );
  }
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-mali font-bold text-gray-800">
                      {purchasedModules.reduce((total, module) => total + (module.fullContent?.length || 0), 0)}
                    </h3>
                  ...
                  <div key={module.id} className="border border-gray-200 rounded-2xl p-4 hover:shadow-lg transition-shadow">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="font-mali text-sm text-gray-600">{module.fullContent?.length || 0} activities</p>
                      </div>
                    </div>
                    <button 
                      onClick={() => setActiveTab('my-content')}
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  <div className="flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full">
                    ...
                    <span className="font-mali font-bold text-sm">
                      {purchasedModules.reduce((total, module) => total + (module.fullContent?.length || 0), 0)} Activities
                    </span>
                  </div>
                  <div className="flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full">
                    ...
                    <div className="p-4 sm:p-6">
                      {!isPurchased ? (
                        <div className="text-center py-8">
                          ...
                          <p className="font-mali text-gray-500 text-sm mb-4">Get full access to all {module.fullContent?.length || 0} activities</p>
                          <button
                            onClick={() => {
                              setActiveTab('store');
                            }}
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between mb-4">
                            <h4 className="font-mali font-bold text-gray-800">Activities ({module.fullContent?.length || 0})</h4>
                          </div>
