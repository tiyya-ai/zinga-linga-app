...
export const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
  ...
  return (
    <>
      ...
      {/* Demo Section with YouTube Video */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl font-mali text-pink-100 mb-8">
              See Kiki and Tano in action with this amazing video
            </p>
          </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                  <iframe
                    src="https://www.youtube.com/embed/RiYzD1h-YVQ"
                    title="Zinga Linga Adventure Video"
                ...
                <div className="mt-6 text-center">
                  <h3 className="text-2xl font-mali font-bold text-white mb-2">Amazing Adventure Preview</h3>
                  <p className="font-mali text-pink-100 mb-4">
                    Watch this incredible video to see what awaits your child in our African alphabet adventure!
                  </p>
                  <button 
                    onClick={onLoginClick}
